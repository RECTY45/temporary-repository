                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('service-requests.show', $bengkel) }}"
                                class="btn btn-sm btn-secondary">Kembali</a>
                        </div>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('service-requests.store', $bengkel) }}" method="POST"
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                    rows="5" required placeholder="Mohon jelaskan masalah kendaraan Anda secara detail...">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="form-text text-muted">Jelaskan sejelas mungkin masalah yang Anda
                                    alami.</small>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <small class="form-text text-muted d-block mt-2">Klik tombol untuk mendeteksi lokasi
                                    Anda secara otomatis.</small>
                            </div>

                            <div class="alert alert-info">
                                <strong>Catatan:</strong> Bengkel akan diberitahu tentang permintaan layanan Anda dan
                                dapat menerima atau menolaknya. Anda dapat melacak status permintaan Anda.
                            </div>
                ...
                getCurrentLocationBtn.addEventListener('click', function() {
                    if (navigator.geolocation) {
                        ...
                        getCurrentLocationBtn.innerHTML =
                            '<i class="fas fa-spinner fa-spin me-2"></i>Mendapatkan lokasi...';
                        ...
                        navigator.geolocation.getCurrentPosition(
                            function(position) {
                                ...
                                getCurrentLocationBtn.innerHTML =
                                    '<i class="fas fa-check me-2"></i>Lokasi Diperoleh';
